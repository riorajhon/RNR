...
<main class="dashboard-app">
  ...
  <section class="dashboard-section dashboard-settings">
    ...
    <form id="dashboard-settings-form" class="dashboard-form">
      ...
      <div class="form-group">
        <span class="form-label">Send happy customers (rating 8–10) to review. Tick platforms and enter your review page URL for each.</span>
        <div class="review-platforms-table-wrap" role="region" aria-label="Review platforms">
          <table class="review-platforms-table">
            <thead>
              <tr>
                <th class="th-platform">Platform</th>
                <th class="th-name">Name</th>
                <th class="th-url">Review page URL</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td class="td-name"></td>
                <td class="td-url">
                  <input type="url" name="review_url_google" id="review_url_google" placeholder="https://g.page/r/... or your Google review link" class="platform-url-input">
                </td>
              </tr>
              <tr>
                <td class="td-platform">
                ...
                <td class="td-name"></td>
                <td class="td-url">
                  <input type="url" name="review_url_facebook" id="review_url_facebook" placeholder="https://www.facebook.com/yourpage/reviews" class="platform-url-input">
                </td>
              </tr>
              <tr>
                <td class="td-platform">
                ...
                <td class="td-name"></td>
                <td class="td-url">
                  <input type="url" name="review_url_yelp" id="review_url_yelp" placeholder="https://www.yelp.com/biz/your-business" class="platform-url-input">
                </td>
              </tr>
              <tr>
                <td class="td-platform">
                ...
                <td class="td-name"></td>
                <td class="td-url">
                  <input type="url" name="review_url_tripadvisor" id="review_url_tripadvisor" placeholder="https://www.tripadvisor.com/.../your-place" class="platform-url-input">
                </td>
              </tr>
              <tr class="row-other">
                <td class="td-platform">
                  <label class="platform-option">
                    ...
                    <span class="platform-icon platform-other" aria-hidden="true"><svg viewBox="0 0 24 24" width="20" height="20"><path fill="#6b7280" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg></span>
                    <span>Any other</span>
                  </label>
                </td>
                <td class="td-name">
                  <input type="text" name="review_label_other" id="review_label_other" placeholder="e.g. Trustpilot" class="platform-label-input" maxlength="128" aria-label="Name of the review site">
                </td>
                <td class="td-url">
                  <input type="url" name="review_url_other" id="review_url_other" placeholder="https://..." class="platform-url-input" aria-label="Review page URL">
                </td>
              </tr>
            </tbody>
          </table>
...
(function() {
  ...
  function loadSettings() {
    api('dashboard.php?action=settings').then(function(s) {
      ...
      var rpList = (s.review_platform || 'google').split(',').map(function(x) { return x.trim(); }).filter(function(x) { return ['google','yelp','facebook','tripadvisor','other'].indexOf(x) >= 0; });
      ...
      var urlIds = { google: 'review_url_google', facebook: 'review_url_facebook', yelp: 'review_url_yelp', tripadvisor: 'review_url_tripadvisor', other: 'review_url_other' };
      Object.keys(urlIds).forEach(function(p) {
        var el = document.getElementById(urlIds[p]);
        if (el && s['review_url_' + p] !== undefined) el.value = s['review_url_' + p] || '';
      });
      var labelOther = document.getElementById('review_label_other');
      if (labelOther && s.review_label_other !== undefined) labelOther.value = s.review_label_other || '';
...
.review-platforms-table-wrap { margin-top: 0.5rem; border: 1px solid var(--color-border); border-radius: 10px; overflow-x: auto; background: #fff; }
.review-platforms-table { width: 100%; border-collapse: collapse; table-layout: fixed; font-size: 0.9rem; }
.review-platforms-table th,
.review-platforms-table td { padding: 0.6rem 1rem; text-align: left; vertical-align: middle; border-bottom: 1px solid var(--color-border); }
.review-platforms-table th { background: var(--color-bg-alt, #f9fafb); font-weight: 600; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.04em; color: var(--color-text-muted); }
.review-platforms-table .th-platform { width: 28%; }
.review-platforms-table .th-name { width: 140px; }
.review-platforms-table .th-url { width: auto; }
.review-platforms-table tbody tr:last-child td { border-bottom: none; }
.review-platforms-table .platform-option { margin: 0; display: inline-flex; align-items: center; gap: 0.5rem; flex-shrink: 0; cursor: pointer; }
.review-platforms-table .td-url .platform-url-input { width: 100%; min-width: 0; padding: 0.5rem 0.75rem; border: 1px solid var(--color-border); border-radius: 8px; font-size: 0.9rem; box-sizing: border-box; }
.review-platforms-table .td-name .platform-label-input { width: 100%; min-width: 0; padding: 0.5rem 0.75rem; border: 1px solid var(--color-border); border-radius: 8px; font-size: 0.9rem; box-sizing: border-box; }
@media (max-width: 640px) {
  .review-platforms-table { table-layout: auto; }
  .review-platforms-table .th-platform,
  .review-platforms-table .th-name { width: auto; }
  .review-platforms-table .td-url .platform-url-input,
  .review-platforms-table .td-name .platform-label-input { font-size: 0.875rem; }
}
